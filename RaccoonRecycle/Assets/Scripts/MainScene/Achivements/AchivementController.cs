...
public class AchivementController : MonoBehaviour
{
    ...
    void Achievement_General(int AchNumber, int[] requirements, float control) //achnumber -> achievment száma, requirements -> számok amikre ellenõrzi, control-> a szám amit a requirements-hez hasonlít
    {
        int a = 0;
    ...
    void Achievement_Any(int AchNumber, int[] requirements, int[] controls) //achnumber -> achievment száma, requirements -> számok amikre ellenõrzi, control-> a számok amit a requirements-hez hasonlít / legalább egyik jó legyen
    {
        int a = 0;
        bool van = false;
        for (int i = 0; i < requirements.Length; i++)
    ...
    void Achievement_All(int AchNumber, int[] requirements, int[] controls) //achnumber -> achievment száma, requirements -> számok amikre ellenõrzi, control-> a számok amik összegét a requirements-hez hasonlítja
    {
        int a = 0;
        int sum = 0;
        for (int j = 0; j < controls.Length; j++)
    ...
    void Achievement_MaxFull(int AchNumber, int requirement, int[] controls) //achnumber -> achievment száma, requirement -> elérendõ feltétel, control-> a számok amiket ellenõriz, osszesnek meg kell felelnie
    {
        int a = 1;
        int count = 0;
        for (int j = 0; j < controls.Length; j++)
    ...
    void Achievement_value(int AchNumber, int[] requirements, int control, float defValue)  //achnumber -> achievment száma, requirements -> számok amikre ellenõrzi, control -> szintje a value-nak, defValue-> alap értéke a szemétnek
    {

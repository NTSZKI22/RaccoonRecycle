...
module.exports = app => {
    app.post("/api/getAchievements", urlencodedParser, async (req, res) => {  //postot használunk mivel a kérés küldésekor a bodyban szeretnénk küldeni az adatokat.    
        ...
        if(verified){
            ...
            res.send(achievements)//elküldjük a mentést.
        }
        else{
